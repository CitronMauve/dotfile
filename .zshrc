...
# Path to your oh-my-zsh installation.
  export ZSH="/home/khry/.oh-my-zsh"
...
# Alias for running, stopping and restarting lampp
...
# cd alias to Courses folder
alias courses='cd ~/Work/Courses'

# cd alias to Projects folder
